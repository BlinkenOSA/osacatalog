(function($) {
    ...
    StickyRows.fn = $.StickyRows.prototype = {
        ...
        init: function(el, options) {
            ...
            this.offsetPixels = this.opts.offsetPixels;
        ...
        redraw: function(mode) {
            ...
            var containerScrollTop = this.container.$element.scrollTop() + this.opts.offsetPixels;
        ...
        calculateDimensions: function() {
            ...
            if (!this.stickyHead) {
                var $element = $('<div/>').addClass('sticky-header hidden').css({'top': this.container.offset.top - bodyCorrection.top + this.opts.offsetPixels, 'left': this.table.offset.left + this.container.scroll.left - bodyCorrection.left, 'width': this.container.width}).insertBefore(this.table.$element);
                ...
                this.stickyHead.$element.css({'top': this.container.offset.top - bodyCorrection.top + this.opts.offsetPixels, 'left': this.table.offset.left + this.container.scroll.left - bodyCorrection.left, 'width': this.container.width});
