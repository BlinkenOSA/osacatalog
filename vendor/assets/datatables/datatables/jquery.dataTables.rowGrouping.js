...
(function ($) {
    ...
    $.fn.rowGrouping = function (options) {
        ...
        var defaults = {
            ...
            oHideEffect: { method: "hide", duration: "fast", easing: "swing" }, // { method: "hide", duration: "fast", easing: "linear" },
            oShowEffect: { method: "show", duration: "fast", easing: "swing" },//{ method: "show", duration: "slow", easing: "linear" }
