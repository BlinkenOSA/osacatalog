...
<xsl:stylesheet xmlns="http://www.loc.gov/MARC21/slim"
	...
	<xsl:template match="foxml:digitalObject/foxml:datastream[@ID='ITEM-LIB-RU'] |
	                     foxml:digitalObject/foxml:datastream[@ID='ITEM-LIB-PL'] |
	                     foxml:digitalObject/foxml:datastream[@ID='ITEM-LIB-HU']">
							...
							<div>
								<a>
									<xsl:attribute name="href">
                                        ...
                                        <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='110']/*[@code='a'][$pos]/." />
									</xsl:attribute>
									<xsl:value-of select="."/>
								</a>
							</div>
							...
							<div>
								<a>
									<xsl:attribute name="href">
                                        ...
                                        <xsl:variable name="pos" select="position()"/>
                                        <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='700'][$pos]/*[@code='a']" />
									</xsl:attribute>
						...
						<xsl:for-each select=".//*[@tag='710']">
							...
							<a>
									<xsl:attribute name="href">
                                        ...
                                        <xsl:variable name="pos" select="position()"/>
                                        <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='710'][$pos]/*[@code='a']" />
                                        <xsl:if test="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='710'][$pos]/*[@code='b']">
												<xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='710'][$pos]/*[@code='b']"/>
										</xsl:if>
									</xsl:attribute>
									<xsl:value-of select="*[@code='a']"/>
									<xsl:if test="*[@code='b']">
						...
						<xsl:for-each select=".//*[@tag='653']/*[@code='a']">
							<a>
								<xsl:attribute name="href">
                                    ...
                                    <xsl:variable name="pos" select="position()"/>
                                    <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='653']/*[@code='a'][$pos]/." />
								</xsl:attribute>
								<xsl:value-of select="."/>
							</a>
							<xsl:if test="not(position() = last())">
						...
						<div>
							<a>
								<xsl:attribute name="href">
                                    ...
                                    <xsl:variable name="pos" select="position()"/>
                                    <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='600'][$pos]/*[@code='a']" />
									<xsl:if test="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='600'][$pos]/*[@code='d']">
										<xsl:text> </xsl:text>
										<xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='600'][$pos]/*[@code='d']"/>
									</xsl:if>
								</xsl:attribute>
								<xsl:value-of select="./*[@code='a']"/>
								<xsl:if test="./*[@code='d']">
						...
						<div>
							<a>
								<xsl:attribute name="href">
                                    ...
                                    <xsl:variable name="pos" select="position()"/>
                                    <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='610'][$pos]/*[@code='a']" />
                                    <xsl:if test="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='610'][$pos]/*[@code='d']">
                                      <xsl:text> </xsl:text>
                                      <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='610'][$pos]/*[@code='d']"/>
                                    </xsl:if>
								</xsl:attribute>
								<xsl:value-of select="./*[@code='a']"/>
								<xsl:if test="./*[@code='b']">
						...
						<div>
							<a>
								<xsl:attribute name="href">
									<xsl:text>/catalog?f[subject_facet][]=</xsl:text>
                                    <xsl:variable name="pos" select="position()"/>
                                    <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='650'][$pos]/*[@code='a']" />
                                    <xsl:if test="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='650'][$pos]/*[@code='z']">
                                      <xsl:text> -- </xsl:text>
                                      <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='650'][$pos]/*[@code='z']"/>
                                    </xsl:if>
								</xsl:attribute>
								<xsl:value-of select="./*[@code='a']"/>
								<xsl:if test="./*[@code='z']">
							...
							<div>
								<a>
									<xsl:attribute name="href">
                                        ...
                                        <xsl:variable name="pos" select="position()"/>
                                        <xsl:value-of select="//foxml:datastream[@ID='ITEM-LIB-EN']//*[@tag='651']/*[@code='a'][$pos]" />
									</xsl:attribute>
									<xsl:value-of select="."/>
								</a>
							</div>
